...
function ResetPasswordForm() {
  ...
  if (!token || !email) {
    return (
      <div className="rounded-xl bg-red-50 border border-red-200 px-4 py-4 text-sm text-red-700 text-center space-y-2">
        <p className="text-2xl">⚠️</p>
        <p>Invalid or missing reset link. Please request a new one.</p>
        <Link
          href="/forgot-password"
          className="inline-block mt-2 text-[#C9A227] font-medium hover:underline"
        >
          Request new link →
        </Link>
      </div>
