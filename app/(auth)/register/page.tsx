      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmitStep1)} className="space-y-4" noValidate>
          ...
          <div className="space-y-1.5">
            ...
            <Input id="name" placeholder="Your full name" className="focus-visible:ring-[#C9A227]" {...register('name')} />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="email" type="email" placeholder="you@example.com" className="focus-visible:ring-[#C9A227]" {...register('email')} />
          ...
          <div className="space-y-1.5">
            ...
            <Input id="password" type="password" placeholder="Min. 8 characters" className="focus-visible:ring-[#C9A227]" {...register('password')} />
            {errors.password && <p className="text-xs text-red-500">{errors.password.message}</p>}
          </div>

          <div className="space-y-1.5">
            <Label htmlFor="password_confirmation">Confirm password</Label>
            <Input id="password_confirmation" type="password" placeholder="Repeat password" className="focus-visible:ring-[#C9A227]" {...register('password_confirmation')} />
